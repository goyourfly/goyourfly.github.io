...
那`SurfaceView`又是什么呢？    
![SurfaceView](http://upload-images.jianshu.io/upload_images/599109-dca8bf923ab5b395.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

从官方文档看，`SurfaceView`继承自android.view.View，也就是说，`SurfaceView`也是和`ImageView`，`TextView`类似的一个普通的View。

然后再看看官方对`SurfaceView`的介绍：
![SurfaceView官方介绍](http://upload-images.jianshu.io/upload_images/599109-2bc47278e78e7813.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

第一句`提供一个嵌入在View树，专用于绘制Surface`，View树我想大家都知道类似如下，可以用Android Tool：View Hierarchy查看
![View Tree](http://upload-images.jianshu.io/upload_images/599109-397960c390d9c663.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
那什么是Surface呢？
![Surface](http://upload-images.jianshu.io/upload_images/599109-5a2b551067f2a203.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
从中可以看到，`Surface`继承自`Object`而不是`View`，且实现了`Parcelable`，可见`Surface`不是一个传统意义上的`View`。
再看看官方介绍

![Surface官方介绍](http://upload-images.jianshu.io/upload_images/599109-8a41d4b6f72c43ab.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![Surface的方法](http://upload-images.jianshu.io/upload_images/599109-4bc4746dd9676031.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
看一下`lockCanvas`的介绍

![lockCanvas方法介绍](http://upload-images.jianshu.io/upload_images/599109-51b52f88d4f27894.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

...
![SurfaceHolder](http://upload-images.jianshu.io/upload_images/599109-a850f4a3f44ce486.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![getHolder()](http://upload-images.jianshu.io/upload_images/599109-501e866f43f09e64.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

mSurfaceHolder是一个属性，再去看看SurfaceHolder的lockCanvas()方法
![lockCanvas()](http://upload-images.jianshu.io/upload_images/599109-cd482d0e3f737d9b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

继续看internalLockCanvas();

![internalLockCanvas](http://upload-images.jianshu.io/upload_images/599109-0238bb421e4d257c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

该方法要求传入一个矩形区域，返回一个Canvas对象，看看里面做了什么

首先调用mSurfaceLock.lock(),mSurfaceLock是一个ReentrantLock，什么是ReentrantLock？

![ReentrantLock](http://upload-images.jianshu.io/upload_images/599109-7fd1ef8da2cde3da.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

首先，该类是在java.util.concurrent.locks包下，由此可见，它是一个工具类，同时也是跟锁有关，在java中，synchronized同步锁是我们常常见到的，那么ReentrantLock是什么锁呢？

![ReentrantLock介绍](http://upload-images.jianshu.io/upload_images/599109-0bd284162eb765c0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![MyWindow resized方法](http://upload-images.jianshu.io/upload_images/599109-955e35405f194ac7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
